...
Kathford College of Engineering and Management is excited to announce the upcoming 36-hour hackathon program, Kathcode, scheduled for the 10th to 11th of Ashoj 2083 within the college premises. A hackathon is an intensive event where participants collaborate to innovate over a few days. The hackathon will then be followed by a grand pitch presentation where participants will present their ideas to the track sponsors and showcase their project as a solution to a real-life problem. The grand pitch presentation will be held on the 11th of Ashoj, 2083.
